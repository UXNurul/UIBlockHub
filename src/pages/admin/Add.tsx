...
export default function Add() {
    ...
    const [form, setForm] = useState({ framework: "", type: "", variant: "", html: "" });
    ...
    const handleAdd = async () => {
        try {
          ...
          const res = await axios.post<Data>(API_URL, form, {
            headers: {
          ...
          setForm({ framework: "", type: "", variant: "", html: "" });
    ...
    return (
         <div className="max-w-xl mx-auto p-6 bg-gray-100 rounded-lg shadow-lg">
            <h1 className="text-3xl font-bold text-center mb-6">Add Component</h1>
